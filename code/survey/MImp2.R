...
for (j in yearnum){
  parest <- data.frame(
    ...
    new_offense_probation_violation_admissions = floor(as.numeric((mice_imputed_data1.nat[j,7] + mice_imputed_data2.nat[j,7] + mice_imputed_data3.nat[j,7] + mice_imputed_data4.nat[j,7] + mice_imputed_data5.nat[j,7])/5)),
    new_offense_parole_violation_admissions = floor(as.numeric((mice_imputed_data1.nat[j,8] + mice_imputed_data2.nat[j,8] + mice_imputed_data3.nat[j,8] + mice_imputed_data4.nat[j,8] + mice_imputed_data5.nat[j,8])/5)),
    
    overall_population                  = floor(as.numeric((mice_imputed_data1.nat[j,9] + mice_imputed_data2.nat[j,9] + mice_imputed_data3.nat[j,9] + mice_imputed_data4.nat[j,9] + mice_imputed_data5.nat[j,9])/5)),
    violator_population                 = floor(as.numeric((mice_imputed_data1.nat[j,10] + mice_imputed_data2.nat[j,10] + mice_imputed_data3.nat[j,10] + mice_imputed_data4.nat[j,10] + mice_imputed_data5.nat[j,10])/5)),
    technical_violator_population       = floor(as.numeric((mice_imputed_data1.nat[j,11] + mice_imputed_data2.nat[j,11] + mice_imputed_data3.nat[j,11] + mice_imputed_data4.nat[j,11] + mice_imputed_data5.nat[j,11])/5)),
    new_crime_violator_population       = floor(as.numeric((mice_imputed_data1.nat[j,12] + mice_imputed_data2.nat[j,12] + mice_imputed_data3.nat[j,12] + mice_imputed_data4.nat[j,12] + mice_imputed_data5.nat[j,12])/5)),
    technical_probation_violation_population       = floor(as.numeric((mice_imputed_data1.nat[j,13] + mice_imputed_data2.nat[j,13] + mice_imputed_data3.nat[j,13] + mice_imputed_data4.nat[j,13] + mice_imputed_data5.nat[j,13])/5)),
    technical_parole_violation_population       = floor(as.numeric((mice_imputed_data1.nat[j,14] + mice_imputed_data2.nat[j,14] + mice_imputed_data3.nat[j,14] + mice_imputed_data4.nat[j,14] + mice_imputed_data5.nat[j,14])/5)),
    new_offense_probation_violation_population       = floor(as.numeric((mice_imputed_data1.nat[j,15] + mice_imputed_data2.nat[j,15] + mice_imputed_data3.nat[j,15] + mice_imputed_data4.nat[j,15] + mice_imputed_data5.nat[j,15])/5)),
    new_offense_parole_violation_population       = floor(as.numeric((mice_imputed_data1.nat[j,16] + mice_imputed_data2.nat[j,16] + mice_imputed_data3.nat[j,16] + mice_imputed_data4.nat[j,16] + mice_imputed_data5.nat[j,16])/5))
  )
...
natCI.2018all <- rbind(natCI.2018.1,natCI.2018.2,natCI.2018.3,natCI.2018.4,
                       ...
                       natCI.2018.13,natCI.2018.14,natCI.2018.15,natCI.2018.16)
natCI.2019all <- rbind(natCI.2019.1,natCI.2019.2,natCI.2019.3,natCI.2019.4,
                       ...
                       natCI.2019.13,natCI.2019.14,natCI.2019.15,natCI.2019.16)
natCI.2020all <- rbind(natCI.2020.1,natCI.2020.2,natCI.2020.3,natCI.2020.4,
                       ...
                       natCI.2020.13,natCI.2020.14,natCI.2020.15,natCI.2020.16)
natCI.2021all <- rbind(natCI.2021.1,natCI.2021.2,natCI.2021.3,natCI.2021.4,
                       ...
                       natCI.2021.13,natCI.2021.14,natCI.2021.15,natCI.2021.16)
