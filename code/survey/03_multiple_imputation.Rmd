...
### The previous MCLC survey averted costs were calculated from pre-COVID looking at 2019-2020. These costs were **`r dollar_format()(avert19_20last)`**. States were given the opportunity to make data corrections in this year's MCLC survey, and so the current averted costs looking at 2019-2020 are **`r dollar_format()(avert19_20)`**. The difference is **`r dollar_format()(avertdiff)`**.
