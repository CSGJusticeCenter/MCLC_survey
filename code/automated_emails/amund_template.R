...
subject_line_text <- "Test Email: 07/25/2022"
...
test_email <- outlb$create_email(test_email, content_type = "html")$set_subject(paste(subject_line_text))$set_recipients(to = c("atallaksen@csg.org"))
