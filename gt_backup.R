...
basic_table = create_table(df,
                           fig_num = "Data Quality Check",
                           title_text = "Prison Admissions" )
...
basic_table <- basic_table %>%
  ...
  tab_style(style = cell_text(size = px(14)), locations = cells_column_labels(columns = c(previous_2018, previous_2019, previous_2020))) %>%
  ...
  tab_style(style = cell_text(size = px(14)),
            locations = cells_column_labels(
              columns = c(current_2018, current_2019, current_2020, current_2021))) %>%
